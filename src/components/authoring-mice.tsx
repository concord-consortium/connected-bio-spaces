...
import { Formik, Form, Field, FieldArray, FormikProps, FormikHelpers } from "formik";
...
export const MiceAuthoringComponent: React.FC<IProps> = ({initialAuthoring}) => {
  ...
  const allowHideLeftPanel = (values: ConnectedBioAuthoring) => {
    const ui = values.ui!;
  ...
  const validate = (values: ConnectedBioAuthoring) => {
  ...
  const handleResetForm = (resetForm: (nextState?: any) => void) => {
    return () => {
      if (window.confirm(
                              ...
                              <div key={index} className="backpack-item">
                                ...
                                <label>
                                  ...
                                  <Field name={`backpack.collectedMice.${index}.genotype`} as="select">
                                    <option value="RR">RR (brown)</option>
                                    <option value="RC">RC (tan)</option>
                                    <option value="CR">CR (tan)</option>
                                    <option value="CC">CC (white)</option>
                                  </Field>
                                </label>
